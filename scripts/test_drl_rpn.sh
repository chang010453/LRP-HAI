...
WEIGHTS_PATH=/home/user/LRP-HAI/LRP-HAI-training-results/experiment/drl-model-2/${DATASET}/${NET}/drl-model-2-1/output/${NET}_LRP_HAI/${TRAIN_IMDB}/${NET}_LRP_HAI_iter_110000.ckpt
