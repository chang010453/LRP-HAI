...
WEIGHTS_PATH=/home/user/LRP-HAI/LRP-HAI-training-results/experiment/L-RPN-HAM/${DATASET}/${NET}/L-RPN-HAM-1/output/${NET}_LRP_HAI/${TRAIN_IMDB}/${NET}_LRP_HAI_iter_110000.ckpt
