...
SAVE_PATH=/media/data/LRP-HAI/TEST/L-RPN-HAM/${DATASET}/${NET}/L-RPN-HAM-1/
WEIGHTS_PATH=/media/data/LRP-HAI/fr-rcnn-weights/${NET}/${TRAIN_IMDB}/default/${NET}_faster_rcnn_iter_180000.ckpt
